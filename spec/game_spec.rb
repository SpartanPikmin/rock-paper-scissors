...
describe 'A game of rock paper scissors' do
  ...
  describe 'playing' do
    ...
    let(:game){Game.new}
    #game.start
    #idea was to reduce repeatition in my test code.
    
    #i also feel that, there should only be one assertion per it block.
    #was not sure how to split up the blocks and have the naming be meaning full
